      ...
      <article className="content__about">
        ...
        <section className="content__about__info">
          <section className="information">
            ...
            <h3 className="information__text">{aboutInfo.city}</h3>
            ...
            <article className="information__text"><h3 className="information__text__header">Tech: </h3><p className="information__text__paragraph"> {aboutInfo.Tech}</p></article>
